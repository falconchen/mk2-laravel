...
<div class="">
    ...
    <form class="px-4 py-8 mx-auto mt-8 space-y-8 bg-white rounded md:w-1/2" wire:submit.prevent="submit"
        x-data="{ uploading: false, progress: 0, fail: false }" x-on:livewire-upload-start="uploading = true"
        x-on:livewire-upload-finish="uploading = false" x-on:livewire-upload-error="uploading = false; fail = true"
        ...
        <div class="p-4 space-y-2 border-2 border-gray-300 border-dashed rounded-md bg-gray-50">
        ...
        <button class="w-full px-3 py-2 text-center text-white bg-blue-600 rounded-md hover:bg-blue-700 "
            x-bind:disabled="uploading"
            x-bind:class="{ ' pointer-events-none opacity-50 cursor-not-allowed': uploading }" type="submit">
